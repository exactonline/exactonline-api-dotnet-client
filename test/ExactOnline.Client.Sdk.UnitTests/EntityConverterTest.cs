namespace ExactOnline.Client.Sdk.UnitTests
{
    ...
    public class EntityConverterTest
    {
        ...
        public void EntityConverter_ConvertJsonToObjectList_WithCorrectInput_Succeeds()
        {
            ...
            var accounts = _entityConverter.ConvertJsonArrayToObjectList<Account>(jsonarray);
            if (accounts.Count != 2)
            {
        ...
        {
            var accounts = _entityConverter.ConvertJsonArrayToObjectList<Account>(string.Empty);
        ...
        public void EntityConverter_ConvertObjectToJson_ForCreating_Succeeds()
        {
            ...
            const string expected =
                "{\"Code\":\"123\",\"Description\":\"FOO\",\"Id\":\"53697fab-137f-4242-b710-0139886b50f4\",\"StartDate\":\"2013-12-16T10:10:17.287\",\"EndDate\":null,\"Boolean\":true,\"NullableBoolean\":null,\"Integer\":5,\"NullableInteger\":null}";

            var converter = new EntityConverter();
            var result = converter.ConvertObjectToJson(simpleEntity, null);
        ...
        [TestMethod]
        public void
            EntityConverter_ConvertObject_WithJsonPropertyAttributeSpecifyingDifferentPropertyToJson_SerializesToCorrectJson()
        {
            var bankaccount = new BankAccount();
            bankaccount.BankAccountName = "value";
            const string jsonValue = @"{""BankAccount"":""value""}";

            var json = _entityConverter.ConvertObjectToJson(new BankAccount(), bankaccount, null);
            Assert.AreEqual(jsonValue, json);
        }
        ...
        public void EntityConverter_ConvertJsonToDynamicObject_WithCorrectJson_Succeeds()
        {
            ...
            var glaccountObject = _entityConverter.ConvertJsonToDynamicObject(json);
        ...
        public void EntityConverter_ConvertJsonToDynamicObjectCollection_Succeeds()
        {
            ...
            var list = _entityConverter.ConvertJsonToDynamicObjectList(json);
            if (list.Count < 2)
            {
        ...
        {
            var json = ApiResponseCleaner.GetJsonArray(
                JsonFileReader.GetJsonFromFile("Response_Json_Array_SalesInvoice_WithLinkedEntities.txt"));
            var converter = new EntityConverter();
        ...
        {
            var json = ApiResponseCleaner.GetJsonObject(
                JsonFileReader.GetJsonFromFile("Response_Json_Object_SalesInvoice.txt"));
        ...
        public void EntityConverter_ConvertLinkedObjectToJson_Succeeds()
        {
            ...
            var expected =
                JsonFileReader.GetJsonFromFileWithoutWhiteSpace(
                    "Expected_Json_Object_ComplexEntity_WithLinkedEntity.txt");
        ...
        private static EntityController GetEntityController(object o)
        {
            ...
            var entityController = new EntityController(newInvoice, "ID", "4f68481a-7a2c-4fbc-a3a0-0c494df3fa0d",
                new ApiConnectionMock(), null);
        ...
        public void EntityConverter_ConvertExistingLinkedObjectToJson_Succeeds()
        {
            ...
            var json = entityConverter.ConvertObjectToJson((SalesInvoice)entityController.OriginalEntity, newInvoice,
                controllerDelegate);

            const string expected =
                "{\"SalesInvoiceLines\": [{\"Description\": \"ChangedNewInvoiceForEntityWithCollection\"}]}";
            Assert.AreEqual(expected, json);
        ...
        public void EntityConverter_ConvertEmptyLinkedObjectToJson_Succeeds()
        {
            ...
            var expected =
                JsonFileReader.GetJsonFromFileWithoutWhiteSpace(
                    "Expected_Json_Object_ComplexEntity_WithEmptyLinkedEntities.txt");
            Assert.AreEqual(expected, json);
        }
