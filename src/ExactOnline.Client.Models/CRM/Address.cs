namespace ExactOnline.Client.Models.CRM
{
    ...
    public class Address
    {
        ...
        /// <summary>
        ///     Last 5 digits of SIRET number which is an intern sequential number of 4 digits representing the identification
        ///     of the localization of the office
        /// </summary>
        ...
        /// <summary>
        ///     The warehouse linked to the address, if a warehouse is linked the account will be empty. Can only be filled
        ///     for type=Delivery
        /// </summary>
