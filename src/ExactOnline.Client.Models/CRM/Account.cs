namespace ExactOnline.Client.Models.CRM
{
    ...
    {
        /// <summary>
        ///     Reference to the accountant of the customer. Conditions: The referred accountant must have value &gt; 0 in the
        ///     field IsAccountant
        /// </summary>
        ...
        /// <summary>
        ///     Unique key, fixed length numeric string with leading spaces, length 18. IMPORTANT: When you use OData $filter
        ///     on this field you have to make sure the filter parameter contains the leading spaces
        /// </summary>
        ...
        /// <summary>
        ///     Consolidation scenario (Time &amp; Billing). Values: 0 = No consolidation, 1 = Item, 2 = Item + Project, 3 =
        ///     Item + Employee, 4 = Item + Employee + Project, 5 = Project + WBS + Item, 6 = Project + WBS + Item + Employee. Item
        ///     means in this case including Unit and Price, these also have to be the same to consolidate
        /// </summary>
        ...
        /// <summary>
        ///     Determines in combination with the start date if the account is active. If the current date is &gt; end date
        ...
        /// <summary>
        ///     Global Location Number can be used by companies to identify their locations, giving them complete flexibility
        ///     to identify any type or level of location required
        /// </summary>
        ...
        /// <summary>
        ///     Indicates which attachment types should be sent when a sales invoice is printed. Only values in related table
        ///     with Invoice=1 are allowed
        /// </summary>
        ...
        /// <summary>
        ///     Indicates whether the account is an accountant. Values: 0 = No accountant, 1 = True, but accountant doesn
        ///     &apos;t want his name to be published in the list of accountants, 2 = True, and accountant is published in the list
        ///     of accountants
        /// </summary>
        ...
        /// <summary>
        ///     Indicates how invoices are generated from subscriptions. 0 = subscriptions belonging to the same customer are
        ///     combined in a single invoice. 1 = each subscription results in one invoice. In both cases, each individual
        ///     subscription line results in one invoice line
        /// </summary>
        ...
        /// <summary>
        ///     State/Province/County code When changing the Country and the State is filled, the State must be assigned with
        ///     a valid value from the selected country or set to empty
        /// </summary>
        ...
        /// <summary>
        ///     If the status field is filled this means the account is a customer. The value indicates the customer status.
        ///     Possible values: A=None, S=Suspect, P=Prospect, C=Customer
        /// </summary>
        ...
        /// <summary>
        ///     Indicates the VAT status of an account to be able to identify the relation that should be selected in the VAT
        ///     debtor listing in Belgium
        /// </summary>
