namespace ExactOnline.Client.Models.CRM
{
    ...
    public class Quotation
    {
        ...
        /// <summary>
        ///     Date on which the quotation version is entered or printed. Both during entering and printing this date can be
        ///     adjusted
        /// </summary>
        ...
        /// <summary>
        ///     Unique number to indentify the quotation. By default this number is based on the setting for first available
        ///     number
        /// </summary>
        ...
        /// <summary>
        ///     The status of the quotation version. 5 = Rejected, 6 = Reviewed and closed, 10 = Recovery, 20 = Draft, 25 =
        ///     Open, 35 = Processing... , 40 = Printed, 50 = Accepted
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
