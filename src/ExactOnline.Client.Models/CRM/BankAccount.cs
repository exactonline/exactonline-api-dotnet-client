namespace ExactOnline.Client.Models.CRM
{
    ...
    public class BankAccount
    {
        ...
        /// <summary>
        ///     The type indicates what entity the bank account is used for. A = Account (default), E = Employee, K = Cash, P
        ///     = Payment service, R = Bank, S = Student, U = Unknown. Currently it&apos;s only possible to create &apos;Account
        ///     &apos; type bank accounts.
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
