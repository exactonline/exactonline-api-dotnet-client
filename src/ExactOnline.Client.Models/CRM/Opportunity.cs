namespace ExactOnline.Client.Models.CRM
{
    ...
    public class Opportunity
    {
        ...
        /// <summary>
        ///     Indicates what follow up action is to be undertaken to move the opportunity towards a deal. Is used in
        ///     combination with ActionDate
        /// </summary>
        ...
        /// <summary>
        ///     The chance that the opportunity will be closed and won. The default for the probability depends on the default
        ///     from the opportunity stage
        /// </summary>
