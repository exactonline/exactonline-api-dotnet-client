namespace ExactOnline.Client.Models.GeneralJournalEntry
{
    ...
    public class GeneralJournalEntryLine
    {
        ...
        /// <summary>
        ///     Amount in the default currency of the company, If an &apos;Including&apos; VAT code is used this amount
        ///     includes the VAT amount.
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
        public double? AmountDC { get; set; }

        /// <summary>
        ///     Amount in the currency of the transaction. If an &apos;Including&apos; VAT code is used this amount includes
        ///     the VAT amount.
        /// </summary>
        ...
        /// <summary>
        ///     Vat amount in the currency of the transaction. If you want to set this in a POST you have to specify VATCode
        ///     as well.
        /// </summary>
        ...
        /// <summary>
        ///     VATCode can only be used if the general journal has VAT enabled. VAT Lines will be automatically created if
        ///     the VATCode is specified when creating a new general journal entry.
        /// </summary>
        ...
        /// <summary>
        ///     The VAT type determines what the values are in relation to VAT returns. The following values are supported:
        ///     &lt;br&gt;A Sales VAT to pay,&lt;br&gt;D Credit note extra duty to claim,&lt;br&gt;I Purchase basis,&lt;br&gt;M
        ///     Credit note purchase non-deductible,&lt;br&gt;N Purchase non-deductible,&lt;br&gt;O Purchase VAT to claim,&lt;br
        ///     &gt;P Purchase VAT to pay,&lt;br&gt;Q Credit note purchase VAT to claim,&lt;br&gt;R Extra duty to pay,&lt;br&gt;S
        ///     No VAT,&lt;br&gt;V Sales basis,&lt;br&gt;W Credit note purchase basis,&lt;br&gt;X Credit note sales basis,&lt;br
        ///     &gt;Y Credit note purchase VAT to pay,&lt;br&gt;Z Credit note sales VAT to claim
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
