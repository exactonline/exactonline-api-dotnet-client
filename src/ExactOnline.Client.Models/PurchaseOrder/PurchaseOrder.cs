namespace ExactOnline.Client.Models.PurchaseOrder
{
    ...
    public class PurchaseOrder
    {
        ...
        /// <summary>
        ///     Allows you to set the currency for the invoice. You can only do this if you have checked the Variable:
        ///     Currency and Variable: Exchange rate fields in the sales journal settings. Once a line has been created in the
        ///     invoice, the currency can no longer be changed.
        /// </summary>
        ...
        /// <summary>
        ///     This shows how the purchase order was created: 1-Manual entry, 2-Import, 3-Other, 4-Purchase order, 5-Sales
        ///     order, 6-Supplier&apos;s items, 7-Subcontract, 8-Purchase order advice, 9-Shop order, 10-MRP calculation
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
        ...
        /// <summary>
        ///     Shows the reference number associated with the purchase order. Enter a description and reference to make the
        ///     purchase order easier to identify.
        /// </summary>
