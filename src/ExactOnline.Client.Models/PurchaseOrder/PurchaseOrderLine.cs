namespace ExactOnline.Client.Models.PurchaseOrder
{
    ...
    public class PurchaseOrderLine
    {
        ...
        /// <summary>
        ///     Expense related to the Work Breakdown Structure of the selected project. Only available with a professional
        ///     service license
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
        ...
        /// <summary>
        ///     The current stock level of items shown in stock unit. The information is displayed only for items with the
        ///     stock property selected.
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
        ...
        /// <summary>
        ///     The current stock level + the planned quantity to be received - the planned quantity to deliver shown in stock
        ///     unit.
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
        ...
        /// <summary>
        ///     Indicates whether the purchase order line needs to be rebilled. Only available with a professional service
        ///     license
        /// </summary>
