namespace ExactOnline.Client.Models.Purchase
{
    ...
    public class PurchaseInvoice
    {
        ...
        /// <summary>
        ///     The unique number of the purchase invoice. The entry number is based on a setting in the purchase journal and
        ///     incremented for each new purchase invoice.
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
        ...
        /// <summary>
        ///     Indicates the type of the purchase invoice. 8030 Direct purchase invoice, 8031 Direct purchase invoice
        ///     (Credit), 8033 Purchase invoice, 8034 Purchase invoice (Credit)
        /// </summary>
        ...
        /// <summary>
        ///     Guid that identifies the warehouse that will receive the purchased goods. This is mandatory for creating a
