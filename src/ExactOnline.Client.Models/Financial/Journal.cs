namespace ExactOnline.Client.Models.Financial
{
    ...
    public class Journal
    {
        ...
        /// <summary>
        ///     Indicates if the journal allows the exchange rate of the currency of the amounts in the journal entry to be
        ///     changed
        /// </summary>
        ...
        /// <summary>
        ///     Type of Payment service provider. The following values are supported: 1 (Adyen), 2 (Paypal), 3 (Stripe). Is
        ///     mandatory for Journals of Type 16 (Payment service)
        /// </summary>
        ...
        /// <summary>
        ///     Type of Journal. The following values are supported: 10 (Cash) 12 (Bank) 16 (Payment service) 20 (Sales) 21
        ///     (Return invoice) 22 (Purchase) 23 (Received return invoice) 90 (General journal)
        /// </summary>
