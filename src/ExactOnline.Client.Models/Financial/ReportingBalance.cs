namespace ExactOnline.Client.Models.Financial
{
    ...
    public class ReportingBalance
    {
        ...
        /// <summary>
        ///     Status: 20 = Open, 50 = Processed. To get &apos;after entry&apos; results, both Open and Processed amounts
        ///     have to be included. This is by default, so it requires no extra filtering.
        /// </summary>
