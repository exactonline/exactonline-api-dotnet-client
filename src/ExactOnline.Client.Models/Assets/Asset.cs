namespace ExactOnline.Client.Models.Assets
{
    ...
    public class Asset
    {
        ...
        /// <summary>
        ///     In case of a transfer or a split, the original asset ID is saved in this field. This is done to provide
        ///     tracability of the Asset
        /// </summary>
        ...
        /// <summary>
        ///     Amount that is already depreciated when adding an existing asset. Can only be filled when &apos;
        ///     Alreadydepreciated&apos; is on
        /// </summary>
        public double? DepreciatedAmount { get; set; }

        /// <summary>
        ///     Number of periods that already have been depreciated for the asset. Can only be filled when &apos;
        ///     Alreadydepreciated&apos; is on
        /// </summary>
        ...
        /// <summary>
        ///     Investment value of the asset. Currently the field is filled with the PurchasePriceLocal. Can be status &apos;
        ///     Not used&apos; after sources have been cleaned
        /// </summary>
