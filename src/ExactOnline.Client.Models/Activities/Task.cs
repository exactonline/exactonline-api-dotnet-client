namespace ExactOnline.Client.Models.Activities
{
    ...
    public class Task
    {
        ...
        /// <summary>
        ///     Custom type of the task. If both TaskType and CustomTaskType are specified then TaskType is preferred. This
        ///     value is write-only.
        /// </summary>
        ...
        /// <summary>
        ///     The type of the task. This value is write-only.0 = Other (default), 1 = Call, 2 = Request for information, 3 =
        ///     Investigate, 4 = Correspondence, 5 = Create an appointment, 6 = Create a quotation
        /// </summary>
