namespace ExactOnline.Client.Models.SalesInvoice
{
    ...
    public class SalesInvoice
    {
        ...
        /// <summary>
        ///     Extra duty amount in the currency of the transaction. Both extra duty amount and VAT amount need to be
        ///     specified in order to differ this property from automatically calculated.
        /// </summary>
        public Double? ExtraDutyAmountFC { get; set; }

        /// <summary>
        ///     A positive value of the amount indicates that the amount is to be paid by the customer to your G bank
        ///     account.In case of a credit invoice the amount should have negative value when retrieved or posted to Exact.
        /// </summary>
        public Double? GAccountAmountFC { get; set; }

        /// <summary>
        ///     Official date for the invoice. When the invoice is entered it&apos;s equal to the field &apos;EntryDate&apos;.
        ///     During the printing process the invoice date can be entered
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
        ...
        /// <summary>
        ///     Assigned at entry or at printing depending on setting. The number assigned is based on the freenumbers as
        ///     defined for the Journal. When printing the field InvoiceNumber is copied to the fields EntryNumber and
        ...
        /// <summary>
        ///     Number to identify the order. By default the number is based on a setting for the first free number, but you
        ///     can post your own number.
        /// </summary>
        ...
        /// <summary>
        ///     The status of the entry. 10 = draft. During the creation of an invoice draft records occur in the draft modus
        ///     if during an invoice a new page with lines is triggered. If the user leaves the invoice in an abnormal way the
        ///     draft invoices can be recovered. Draft invoices are not included in financial reports, balances etc. 20 = open.
        ///     Open invoices can be changed. New invoices get the status open by default. 50 = processed. Processed invoices can
        ///     &apos;t be changed anymore. Processing is done via printing. Processed invoices can&apos;t be reopened
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
        ...
        /// <summary>
        ///     Indicates the type of invoice Values: 8020 - Sales invoices, 8021 - Sales credit note, 8023 - Direct sales
        ///     invoice, 8024 - Direct credit note
        /// </summary>
