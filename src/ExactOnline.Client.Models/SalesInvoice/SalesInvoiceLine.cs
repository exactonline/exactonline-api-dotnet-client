namespace ExactOnline.Client.Models.SalesInvoice
{
    ...
    public class SalesInvoiceLine
    {
        ...
        /// <summary>
        ///     Delivery date of an item in a sales invoice. This is used for VAT on prepayments, only if sales order is not
        ///     used in the license.
        /// </summary>
        ...
        /// <summary>
        ///     Discount given on the default price. Discount = (DefaultPrice of Item - PriceItem in line) / DefaultPrice of
        ///     Item
        /// </summary>
        ...
        /// <summary>
        ///     The GL Account of the sales invoice line. This field is mandatory. This field is generated based on the
        ///     revenue account of the item (or the related item group). G/L Account is also used to determine whether the
        ///     costcenter / costunit is mandatory
        /// </summary>
        ...
        ///     also used for the default calculation of VAT amounts and VAT base amounts
        /// </summary>
