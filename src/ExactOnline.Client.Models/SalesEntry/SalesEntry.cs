namespace ExactOnline.Client.Models.SalesEntry
{
    ...
    {
        /// <summary>
        ///     Amount in the default currency of the company. For the header lines (LineNumber = 0) of an entry this is the
        ///     SUM(AmountDC) of all lines
        /// </summary>
        ...
        /// <summary>
        ///     The number of the batch of entries. Normally a batch consists of multiple entries. Batchnumbers are filled for
        ///     invoices created by: - Fixed entries - Prolongation (only available with module hosting)
        /// </summary>
        ...
        /// <summary>
        ///     Number to indentify the invoice. Order numbers are not unique. Default the number is based on a setting for
