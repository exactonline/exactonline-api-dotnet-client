namespace ExactOnline.Client.Models.SalesEntry
{
    ...
    {
        /// <summary>
        ///     Amount in the default currency of the company. For almost all lines this can be calculated like: AmountDC =
        ///     AmountFC * RateFC.
        /// </summary>
        ...
        /// <summary>
        ///     The GL Account of the invoice line. This field is generated based on the revenue account of the item (or the
        ///     related item group). G/L Account is also used to determine whether the costcenter / costunit is mandatory
        /// </summary>
        ...
        /// <summary>
        ///     The project to which the sales transaction line is linked. The project can be different per line. Sometimes
        ///     also the project in the header is filled although this is not really used
        /// </summary>
        ...
        /// <summary>
        ///     When generating invoices from subscriptions, this field records the link between invoice lines and
        ///     subscription lines
        /// </summary>
        ...
        /// <summary>
        ///     VAT amount in the currency of the transaction. Use this property to specify a VAT amount that differs from the
        ///     VAT amount that is automatically calculated. However if the transaction uses extra duty, extra duty amount also
        ...
        /// <summary>
        ///     The VAT base amount in invoice currency. This is calculated with the use of VAT codes. It&apos;s an internal
        ///     value
        /// </summary>
        ...
        /// <summary>
        ///     The VAT percentage of the VAT code. This is the percentage at the moment the invoice is created. It&apos;s
        ///     also used by the default calculation of VAT amounts and VAT base amounts
        /// </summary>
