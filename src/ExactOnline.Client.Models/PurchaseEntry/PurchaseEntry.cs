namespace ExactOnline.Client.Models.PurchaseEntry
{
    ...
    public class PurchaseEntry
    {
        ...
        /// <summary>
        ///     A positive value of the amount indicates that the amount is to be paid to the suppliers G bank account.In case
        ///     of a credit invoice the amount should have negative value when retrieved or posted to Exact.
        /// </summary>
