namespace ExactOnline.Client.Models.VAT
{
    ...
    public class VATCode
    {
        ...
        /// <summary>
        ///     Indicates if transactions using the VAT code are transactions of the domestic VAT charging regulation (such as
        ///     those for subcontractors) or transactions that are registered within the EU. If Charged=1 and linked to a purchase
        ///     invoice, both a line for the VAT to pay and a line for the VAT to claim are being created
        /// </summary>
        ...
        /// <summary>
        ///     Used in all legislations except France. Indicates if and how transactions using the VAT code appear on the ICT
        ///     return (EU sales list). L = Listing goods, N = No listing, S = Listing services, T = Triangulation
        /// </summary>
        ...
        /// <summary>
        ///     G/L account that is used to book the VAT to claim. If you enter purchases with a VAT code, the VAT amount to
        ///     be claimed is entered to this VAT account. Must be of type VAT
        /// </summary>
        ...
        /// <summary>
        ///     G/L account that is used to book the VAT to pay. If you enter sales with a VAT code, the VAT amount to be paid
        ///     is entered to this VAT account. Must be of type VAT
        /// </summary>
        ...
        /// <summary>
        ///     Used in France legislation only. Indicates if and how transactions using the VAT code appear on the DEB/DES
        ///     return. L = Goods, N = Empty, S = Services
        /// </summary>
        ...
        /// <summary>
        ///     Indicates how the VAT amount should be calculated in relation to the invoice amount. B = VAT 0% (Only base
        ///     amount), E = Excluding, I = Including, N = No VAT
        /// </summary>
        public string Type { get; set; }

        /// <summary>
        ///     Field in VAT code maintenance to calculate different VATs depending on the selected document type. P =
        ///     purchase invoice, F = freelance invoice, E = expense voucher. The field is valid for witholding tax type
        /// </summary>
        public string VatDocType { get; set; }

        /// <summary>
        ///     The VAT margin scheme is used for the trade of secondhand goods which are purchased without VAT (for example
        ///     when a company buys a secondhand good from a private person). In the VAT margin scheme, the VAT is not calculated
        ///     based on the sales price. Instead of that, the VAT is calculated based on the margin (gross sales price minus the
        ///     gross purchase price)
        /// </summary>
        public byte VatMargin { get; set; }

        /// <summary>
        ///     Partial ratio explains which part of the VAT the company has to pay. Used in some branches where the sellers
        ///     have a bad reputation, so the buyers have to take over the VAT-liability
        /// </summary>
