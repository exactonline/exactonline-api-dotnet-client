namespace ExactOnline.Client.Models.Project
{
    ...
    public class Project
    {
        ...
        /// <summary>
        ///     Used only for PSA to store the budgetted costs of a project (except for project type Campaign and
        ///     Non-billable). Positive quantities only
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
        ...
        /// <summary>
        ///     Item used for fixed price invoicing. To be defined per project. If empty the functionality relies on the
        ///     setting
        /// </summary>
        ...
        /// <summary>
        ///     Used only for PSA. This item is used for prepaid invoicing. If left empty, the functionality relies on a
        ///     setting
        /// </summary>
