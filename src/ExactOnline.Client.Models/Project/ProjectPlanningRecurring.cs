namespace ExactOnline.Client.Models.Project
{
    ...
    public class ProjectPlanningRecurring
    {
        ...
        /// <summary>
        ///     Ordinal number of week day for the monthly recurring planning, 1 = first, 2 = second, 3 = third, 4 = fourth,
        ///     31 = last
        /// </summary>
        public Byte? MonthPatternOrdinalDay { get; set; }

        /// <summary>
        ///     Ordinal week day of the monthly recurring planning, 1 = Monday, 2 = Tuesday, 3 = Wednesday, 4 = Thursday, 5 =
