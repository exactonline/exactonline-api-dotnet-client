namespace ExactOnline.Client.Models.Mailbox
{
    ...
    {
        /// <summary>
        ///     The account this mailbox belongs to. Can be empty if the owner of the mailbox isn&apos;t an Exact Online
        ///     customer yet
        /// </summary>
        ...
        /// <summary>
        ///     Only used when this mailbox is used for one specific administration, for example invoices to this mailbox will
        ///     only be booked in this administration
        /// </summary>
        ...
        /// <summary>
        ///     Customers can decide if they want this mailbox to be visible by all. i.e. some other customer can see this in
        ///     address maintenance for digital postbox of type Exact
        /// </summary>
