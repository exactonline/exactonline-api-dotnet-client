namespace ExactOnline.Client.Models.Mailbox
{
    ...
    {
        /// <summary>
        ///     Bank to/from which the mail message is sent/received. This is used for mail messages of type Bank only. It has
        ///     an attachment containing the bank file. When used for a mail message of type bank, the value is reserved for
        ///     internal use and will then be ignored.
        /// </summary>
        public Guid? Bank { get; set; }

        /// <summary>
        ///     Bank account for which the mail message is sent. This is used for mail messages of type Bank only. It has an
        ///     attachment containing the bank export file. When used for a mail message of type bank, the value is reserved for
        ///     internal use and will then be ignored.
        /// </summary>
        ...
        /// <summary>
        ///     Administration from which the mail message is sent. This is used for mail messages of type Bank only. When
        ///     used for a mail message of type bank, the value is reserved for internal use and will then be ignored.
        /// </summary>
        ...
        /// <summary>
        ///     The partner key that was used: this refers to the application from which the message is originating. It is
        ///     filled with a fixed partnerkey when created from within Exact Online
        /// </summary>
        ...
        /// <summary>
        ///     Indiciates if the recipient deleted this message. If this is the case the recipient can&apos;t see it anymore
        ///     and the sender can actually delete it
        /// </summary>
        ...
        /// <summary>
        ///     Date the message was sent. Default the date the message is created, can be an earlier date when imported from
        ///     xml (the date the xml was sent)
        /// </summary>
        public DateTime? SenderDateSent { get; set; }

        /// <summary>
        ///     Indicates if the sender deleted the message. This means the sender can&apos;t see it anymore and the recipient
