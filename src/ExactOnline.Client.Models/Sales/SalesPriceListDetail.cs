namespace ExactOnline.Client.Models.Sales
{
    ...
    public class SalesPriceListDetail
    {
        ...
        /// <summary>
        ///     Indicates whether discount or the new price is leading : 1-Discount, 2-New price. &lt;br&gt;&lt;br&gt;
        ///     Scenario &lt;br&gt;&lt;br&gt; 1. When entry method is Discount and use base price, Discounted price = (1-
        ///     SalesPriceListDetails.Discount) * SalesPriceListDetails.BasePrice &lt;br&gt;&lt;br&gt; 2. When entry method is
        ///     Discount and use Item&apos;s standard sales price, Discounted price = (1- SalesPriceListDetails.Discount) *
        ///     SalesItemPrices.Price &lt;br&gt;&lt;br&gt; 3. When entry method is New price, Discounted price =
        ///     SalesPriceListDetails.NewPrice
        /// </summary>
