namespace ExactOnline.Client.Models.Cashflow
{
    ...
    public class DirectDebitMandate
    {
        ...
        /// <summary>
        ///     Depending on the payment type, a different bank file will be generated. 0 = One-off payment, 1 = Recurrent
        ///     payment, 2 = AdHoc (UK only)
        /// </summary>
        public Int16? PaymentType { get; set; }

        /// <summary>
        ///     Displays a reference number for the mandate. It is a unique reference number that you can assign to each
        ///     mandate.
        /// </summary>
        public string Reference { get; set; }

        /// <summary>
        ///     Date that the mandate is signed. The collection must take place after the signature date of the mandate. The
        ///     date is used to check the validity of the mandate.
        /// </summary>
