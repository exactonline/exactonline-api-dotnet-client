namespace ExactOnline.Client.Models.Cashflow
{
    ...
    public class Payment
    {
        ...
        /// <summary>
        ///     Contact person copied from the purchase invoice linked to the related purchase entry. Used as prefered contact
        ...
        /// <summary>
        ///     When processing payments, all payments with the same processing data are put in a batch. This field contains
        ///     the code of that batch.
        /// </summary>
        ...
        /// <summary>
        ///     The currency of the payment. This currency can only deviate from the division currency if the module Currency
        ///     is in the license.
        /// </summary>
        ...
        /// <summary>
        ///     Date since when the payment is no longer an outstanding item. This is the highest invoice date of all matched
        ///     payments.
        /// </summary>
        public DateTime? EndDate { get; set; }

        /// <summary>
        ///     Period since when the payment is no longer an outstanding item. This is the highest period of all matched
        ///     payments.
        /// </summary>
        public Int16? EndPeriod { get; set; }

        /// <summary>
        ///     Year (of period) since when the payment is no longer an outstanding item. This is the highest year of all
        ///     matched payments. Used in combination with EndPeriod.
        /// </summary>
        ...
        /// <summary>
        ///     The unique identifier for a set of payments. A payment can be split so that one part is paid on a different
        ///     date. In that case the two records get a different EntryID.
        /// </summary>
        ...
        /// <summary>
        ///     Number assigned during the of processing payments. When payments are processed a bank export file is created.
        ///     This file contains one or more batches that contain one or more payments. Each batch gets a sequence number that is
        ///     stored for each payment in that batch.
        /// </summary>
        ...
        /// <summary>
        ///     Method of payment.&lt;br&gt; B = On credit (default)&lt;br&gt; I = Collection&lt;br&gt; K = Cash&lt;br&gt; V =
        ///     Credit card.
        /// </summary>
        ...
        /// <summary>
        ///     The source of the payment.&lt;br&gt; 1 = manual&lt;br&gt; 2 = reconcile&lt;br&gt; 3 = match&lt;br&gt; 4 =
        ///     import&lt;br&gt; 5 = process
        /// </summary>
        public Int32 Source { get; set; }

        /// <summary>
        ///     The status of the payment.&lt;br&gt; 20 = open&lt;br&gt; 30 = selected - payment is selected to be paid&lt;br
        ///     &gt; 40 = processed - payment has been done&lt;br&gt; 50 = matched - payment is matched with one or more other
        ///     outstanding items or financial statement lines
        /// </summary>
        ...
        /// <summary>
        ///     Invoice number of the supplier. In case the payment belongs to a bank entry line and is matched with one
        ///     invoice, YourRef is filled with the YourRef of this invoice.
        /// </summary>
