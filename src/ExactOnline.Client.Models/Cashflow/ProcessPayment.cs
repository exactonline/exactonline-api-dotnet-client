namespace ExactOnline.Client.Models.Cashflow
{
    ...
    {
        /// <summary>
        ///     This is a URL to get the documents that were created after the payments were successfully processed. These
        ///     documents have to be sent to the bank in order to do the payments.
        /// </summary>
