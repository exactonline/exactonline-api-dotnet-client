namespace ExactOnline.Client.Models.Cashflow
{
    ...
    public class Receivable
    {
        ...
        /// <summary>
        ///     When processing receivables, all receivable with the same processing data are put in a batch. This field
        ///     contains the code of that batch.
        /// </summary>
        ...
        /// <summary>
        ///     The currency of the receivable. This currency can only deviate from the division currency if the module
        ///     Currency is in the license.
        /// </summary>
        ...
        /// <summary>
        ///     Date since when the receivable is no longer an outstanding item. This is the highest invoice date of all
        ///     matched receivables.
        /// </summary>
        public DateTime? EndDate { get; set; }

        /// <summary>
        ///     Period since when the receivable is no longer an outstanding item. This is the highest period of all matched
        ///     receivables.
        /// </summary>
        ...
        /// <summary>
        ///     Year (of period) since when the receivable is no longer an outstanding item. This is the highest year of all
        ///     matched receivables. Used in combination with EndPeriod.
        /// </summary>
        ...
        /// <summary>
        ///     The unique identifier for a set of receivables. A receivable can be split so that one part is received on a
        ///     different date. In that case the two records get a different EntryID.
        /// </summary>
        ...
        /// <summary>
        ///     The source of the receivable.&lt;br&gt; 1 = manual&lt;br&gt; 2 = reconcile&lt;br&gt; 3 = match&lt;br&gt; 4 =
        ///     import&lt;br&gt; 5 = process
        /// </summary>
        public Int32 Source { get; set; }

        /// <summary>
        ///     The status of the receivable.&lt;br&gt; 20 = open&lt;br&gt; 30 = selected - receivable is selected to be
        ///     collected&lt;br&gt; 40 = processed - collection has been done&lt;br&gt; 50 = matched - receivable is matched with
        ...
        /// <summary>
        ///     Invoice number. In case the receivable belongs to a bank entry line and is matched with one invoice, YourRef
        ///     is filled with the YourRef of this invoice.
        /// </summary>
