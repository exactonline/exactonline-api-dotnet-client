namespace ExactOnline.Client.Models.Logistics
{
    ...
    public class Item
    {
        ...
        /// <summary>
        ///     GL account the cost entries will be booked on. This overrules the GL account from the item group. If the
        ///     license contains &apos;Intuit integration&apos; this property overrides the value in Settings, not the item group.
        /// </summary>
        ...
        /// <summary>
        ///     GL account the revenue will be booked on. This overrules the GL account from the item group. If the license
        ///     contains &apos;Intuit integration&apos; this property overrides the value in Settings, not the item group.
        /// </summary>
        ...
        /// <summary>
        ///     GL account the stock entries will be booked on. This overrules the GL account from the item group. If the
        ///     license contains &apos;Intuit integration&apos; this property overrides the value in Settings, not the item group.
        /// </summary>
        ...
        /// <summary>
        ///     If you have the Trade or Manufacturing license and you check this property the item will be shown in the stock
        ///     positions overview, stock counts and transaction lists. If you have the Invoice module and you check this property
        ///     you will get a general journal entry based on the Stock and Costs G/L accounts of the item group. If you don’t want
        ///     the general journal entry to be created you should change the Stock/Costs G/L account on the Item group page to the
        ///     type Costs instead of Inventory.
        /// </summary>
