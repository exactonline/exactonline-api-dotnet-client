namespace ExactOnline.Client.Models.Logistics
{
    ...
    public class SalesItemPrice
    {
        ...
        /// <summary>
        ///     This is the multiplication factor when going from default item unit to the unit of this price.For example if
        ///     the default item unit is &apos;gram&apos; and the price unit is &apos;kilogram&apos; then the value of this
        ///     property is 1000.
        /// </summary>
