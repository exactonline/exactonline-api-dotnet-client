namespace ExactOnline.Client.Models.Inventory
{
    ...
    public class StockCountLine
    {
        ...
        /// <summary>
        ///     The difference between the current quantity in stock and the new quantity in stock. For example specify -1 for
        ///     this field to correct the quantity if one item in stock is broken.
        /// </summary>
        ...
        /// <summary>
        ///     The new quantity in stock. Use this field to correct the quantity when the items in stock are physically
        ///     counted.
        /// </summary>
        ...
        /// <summary>
        ///     This property is package specific (Stock count can have multiple lines for the same item only if it is for
