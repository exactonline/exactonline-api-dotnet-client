namespace ExactOnline.Client.Models.Inventory
{
    ...
    public class Warehouse
    {
        ...
        /// <summary>
        ///     The default storage location of this warehouse. Warehouses can have a default storage location in packages
        ///     Manufacturing Premium or Wholesale Premium
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
        ...
        /// <summary>
        ///     Indicates if this warehouse is using storage locations. The storage locations will not be removed when when
        ///     this is deactivated
        /// </summary>
