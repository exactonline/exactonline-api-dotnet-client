namespace ExactOnline.Client.Models.Inventory
{
    ...
    public class ItemWarehousePlanningDetail
    {
        ...
        /// <summary>
        ///     Human readable description of the PlanningSource (translated to user&apos;s language) - Examples: Purchase
        ///     Order, Sales Order, Shop Order, etc.
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
        ...
        /// <summary>
        ///     Human readable number of the PlanningSource - Examples: Shop order number &apos;201600001&apos; or Sales order
        ///     number &apos;2016020001&apos;
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
        ...
        /// <summary>
        ///     REST API URL of this specific PlanningSource and PlanningSourceID (Assembly orders and warehouse transfers not
        ///     supported over REST)
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
        ...
        /// <summary>
        ///     Type of the PlanningSource - 120=GoodsDelivery, 124=WarehouseTransferDelivery, 130=GoodsReceipt,
        ///     134=WarehouseTransferReceipt, 140=ShopOrderStockReceipt, 147=ShopOrderByProductReceipt, 150=ShopOrderRequirement,
        ///     160=AssemblyOrderReceipt, 165=AssemblyOrderIssue
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
        public Int32? PlanningType { get; set; }

        /// <summary>
        ///     Human readable description of the PlanningSourceType (translated to user&apos;s language) - Examples: &apos;
        ///     Shop order stock receipt&apos; or &apos;Goods delivery&apos;
        /// </summary>
        [SDKFieldType(FieldType.ReadOnly)]
