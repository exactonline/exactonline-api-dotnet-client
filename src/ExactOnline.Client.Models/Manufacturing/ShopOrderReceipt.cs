namespace ExactOnline.Client.Models.Manufacturing
{
    ...
    public class ShopOrderReceipt
    {
        ...
        /// <summary>
        ///     Serial or batch numbers are reserved prior to a POST to ShopOrderReceipts. This DraftStockTransactionID
        ///     represents the group of serial or batch numbers to be used in this transaction.
        /// </summary>
