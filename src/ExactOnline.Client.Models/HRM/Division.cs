namespace ExactOnline.Client.Models.HRM
{
    ...
    {
        /// <summary>
        ///     Values: 0 = Not blocked 1 = Backup 2 = Conversion busy 3 = Conversion shadow 4 = Conversion waiting 5 = Copy
        ///     data waiting 6 = Copy data buzy 100 = Wait for deletion 101 = Deleted 102 = Deletion failed
        /// </summary>
        ...
        /// <summary>
        ///     Regular administrations will have status 0.  Currently, the only other possibility is &apos;archived&apos;
        ///     (1), which means the administration is not actively used, but still needs to be accessible for the
        ///     customer/accountant to meet legal obligations
        /// </summary>
