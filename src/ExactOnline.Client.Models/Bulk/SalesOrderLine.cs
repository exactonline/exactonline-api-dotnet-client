namespace ExactOnline.Client.Models.Bulk
{
    ...
    public class SalesOrderLine
    {
        ...
        /// <summary>
        ///     The project to which the sales order line is linked. The project can be different per line. Sometimes also the
        ///     project in the header is filled although this is not really used
        /// </summary>
        ...
        /// <summary>
        ///     The vat percentage of the VAT code. This is the percentage at the moment the sales order is created. It&apos;s
