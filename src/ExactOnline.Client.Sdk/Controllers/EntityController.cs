namespace ExactOnline.Client.Sdk.Controllers
{
    ...
    public class EntityController
    {
        ...
        public EntityController(object entity, string keyName, string identifier, IApiConnection connection,
            GetEntityController entityControllerDelegate)
        {
        ...
        private static object Clone(object entity)
        {
            ...
            foreach (var property in entity.GetType().GetProperties().Where(p => p.CanWrite))
            {
        ...
        public Boolean Update(object entity)
        {
            ...
            var json = converter.ConvertObjectToJson(OriginalEntity, entity, _entityControllerDelegate);
