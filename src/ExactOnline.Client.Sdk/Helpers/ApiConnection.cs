...
namespace ExactOnline.Client.Sdk.Helpers
{
    ...
    public class ApiConnection : IApiConnection
    {
        ...
        /// <summary>
        /// Perform asynchronous GET (Read) request on the API
        /// </summary>
        ...
        {
            Stream response = await _conn.DoGetFileRequestAsync(EndPoint);
            return response;
        }
        /// <summary>
        /// Perform a GET (Read) request on the API
        ...
        /// <summary>
        /// Performs asynchronous GET (Read) request on the API for one specific entity
        /// </summary>
        ...
        /// <summary>
        /// Performs asynchronous POST (Create) request on the API
        /// </summary>
        ...
        /// <summary>
        /// Performs asynchronous PUT Request (Update) on the API
        /// </summary>
        ...
        /// <summary>
        /// Performs asynchronous DELETE Request on the API
        /// </summary>
        /// <param name="keyName">Name of key field</param>
        /// <param name="guid">Global Unique Identifier of the entity</param>
        /// <returns>True if succeeded</returns>
