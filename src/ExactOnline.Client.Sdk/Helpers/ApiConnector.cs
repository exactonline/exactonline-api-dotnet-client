namespace ExactOnline.Client.Sdk.Helpers
{
    ...
    public class ApiConnector : IApiConnector
    {
        ...
        /// <param name="client">Client in use.</param>
        ...
        public string DoGetRequest(string endpoint, string oDataQuery)
        {
            ...
            {
                throw new ArgumentException("Cannot perform request with empty endpoint");
            }
        ...
        {
            if (string.IsNullOrEmpty(endpoint) || string.IsNullOrEmpty(postdata))
            {
                throw new ArgumentException("Cannot perform request with empty endpoint or postdata");
            }
        ...
        {
            if (string.IsNullOrEmpty(endpoint) || string.IsNullOrEmpty(putData))
            {
                throw new ArgumentException("Cannot perform request with empty endpoint or putData");
            }
