...
namespace ExactOnline.Client.Sdk.Helpers
{
	...
	public class ApiConnector : IApiConnector
	{
        ...
        /// <summary>
        /// Read Data: Perform asynchronous GET Request on the API
        /// </summary>
        ...
        public async Task<Stream> DoGetFileRequestAsync(string endpoint)
        {
            if (string.IsNullOrEmpty(endpoint)) throw new ArgumentException("Cannot perform request with empty endpoint");
            ...
            return await GetResponseFileAsync(request);
        }
        /// <summary>
        /// Read Data: Perform a GET Request on the API
        /// </summary>
        ...
        /// <summary>
        /// Create Data: Perform asynchronous POST Request on the API
        /// </summary>
        /// <param name="endpoint">{URI}/{Division}/{Resource}/{Entity}</param>
        ...
        /// <summary>
        /// Update data: Perform asynchronous PUT Request on API
        /// </summary>
        /// <param name="endpoint">{URI}/{Division}/{Resource}/{Entity}</param>
        ...
        /// <summary>
        /// Delete entity: Perform asynchronous DELETE Request on API
        /// </summary>
        /// <param name="endpoint">{URI}/{Division}/{Resource}/{Entity}</param>
        /// <returns>String with API Response in Json Format</returns>
        ...
        /// <summary>
        /// Endpoint to get response from different apis types
        /// </summary>
        ...
        /// <returns></returns>
        public async Task<string> DoCleanRequestAsync(string uri, string oDataQuery)
        {
